...
#ifndef EnvironmentBmp_h
#define EnvironmentBmp_h

#include "Arduino.h"
#include "../data/Bitmap.h"


class EnvironmentBmp : public Bitmap
{
  public:

    EnvironmentBmp(Screen &obj1, Mouse &obj2) : Bitmap(obj1, obj2) {};
    ...
    void    handleHistoryPage(String title, vfield field, int currentDelay, vcolor bgColor, int offset);
    ...
    void    handleRealtimeUpdate(Sensor &sensor, int length, int processedChecks, int offset);
