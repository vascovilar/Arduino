...
String VDataHtml::handleHistorySvgGraph(vfield_data data, VDataBuffer buffer)
{
...
String VDataHtml::handleDataTable(vfield_data* sensors, int length)
{
...
String VDataHtml::_getHtmlColor(vcolor_code code)
{
...
String VDataHtml::_getHtmlColor(vstatus_code code) 
{
  switch (code) {
    case GRIS:
